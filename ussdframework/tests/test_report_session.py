from ussdframework.tests import UssdTestCase, TestCase
from unittest import mock
from django.test import override_settings
from django.http.response import JsonResponse
from ussdframework.core import ussd_session
...
class TestingUssdReportSession(UssdTestCase.BaseUssdTestCase, TestCase):
    ...
    @mock.patch("ussdframework.core.report_session.apply_async")
    ...
    @staticmethod
    @mock.patch('ussdframework.core.requests.request')
    ...
    @mock.patch("ussdframework.tasks.requests.request")
