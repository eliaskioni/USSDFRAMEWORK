...
class FunctionScreenSerializer(NextUssdScreenSerializer):
    ...
    2. session_key
        ...
        will be saved in ussdframework session using session_key
    3. next_screen
...
class FunctionScreen(UssdHandlerAbstract):
    ...
    And it should return a dictionary that will be saved in ussdframework session

    Below is the UssdRequest that will be used.
        .. autoclass:: ussdframework.core.UssdRequest

    Screen specification
        .. autoclass:: ussdframework.screens.function_screen.FunctionScreenSerializer

    Examples of function screens:
        .. literalinclude:: .././ussdframework/tests/sample_screen_definition/valid_function_screen_conf.yml
    """
