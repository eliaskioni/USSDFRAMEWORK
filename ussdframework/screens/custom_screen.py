from ussdframework.core import UssdHandlerAbstract, UssdHandlerMetaClass
from ussdframework.screens.serializers import UssdBaseSerializer
from rest_framework import serializers
from ussdframework.utilities import str_to_class
...
class CustomScreen(UssdHandlerAbstract):
    ...
    This screen allows us to define our own ussdframework screen.
    ...
    EXAMPLE:
        ...
        example of defining a yaml
            ...
            .. literalinclude:: .././ussdframework/tests/sample_screen_definition/valid_menu_screen_conf.yml
    """
