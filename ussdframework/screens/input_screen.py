...
from ussdframework.screens.menu_screen import MenuScreen
...
class InputScreen(MenuScreen):
    ...
    Fields required:
        ...
        - validators:
            - text: This is the message to display when the validation fails
              regex: regex used to validate ussdframework input. Its mutually exclusive
              with expression
            - expression: if regex is not enough you can use a jinja expression
             will be called ussdframework request object
    ...
    Example:
        .. literalinclude:: .././ussdframework/tests/sample_screen_definition/valid_input_screen_conf.yml
    """
