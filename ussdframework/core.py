...
from ussdframework.models import SessionLookup
from annoying.functions import get_object_or_None
from ussdframework import defaults as ussd_airflow_variables
from django.utils import timezone
import requests
import inspect
from ussdframework.tasks import report_session
from ussdframework import utilities
...
class UssdRequest(object):
    ...
    :param input:
        This ussdframework input the user has entered.

    :param language:
        Language to use to display ussdframework
...
class UssdResponse(object):
    """
    :param text:
        This is the ussdframework text to display to the user
    :param status:
        This shows the status of ussdframework session.

        True -> to continue with the session

        False -> to end the session
    :param session:
        This is the session object of the ussdframework session
    """
    ...
    To create Ussd View requires the following things:
        - Inherit from **UssdView** (Mandatory)
            .. code-block:: python
                ...
                from ussdframework.core import UssdView

        - Define Http method either **get** or **post** (Mandatory)
            The http method should return Ussd Request

                .. autoclass:: ussdframework.core.UssdRequest

        - define this varialbe *customer_journey_conf*
            This is the path of the file that has ussdframework screens
        ...
        - override HttpResponse
            In ussdframework airflow the http method return UssdRequest object
            not Http response. Then ussdframework view gets UssdResponse object
            and convert it to HttpResponse. The default HttpResponse
            returned is a normal HttpResponse with body being ussdframework text

            To override HttpResponse returned define this method.
            **ussd_response_handler** it will be called with
            **UssdResponse** object.

                .. autoclass:: ussdframework.core.UssdResponse
